...
/-
Evidence/RegionNext7.lean — ROW 326'S REMAINING HYPOTHESES, FOURTH PART (§119-§126)

Split out of `RegionNext6` at 12500 lines, then split again at 8600.  Section numbers are
not in file order — sections were appended as their agents finished.  `RegionNext8` carries
