...
/-
Evidence/RegionNext5.lean — ROW 326'S REMAINING HYPOTHESES, SECOND HALF (§104-§112)

Split out of `RegionNext4` at 14000 lines, then split again at 12900.  Section numbers are
not in file order — sections were appended as their agents finished.  `RegionNext6` carries
