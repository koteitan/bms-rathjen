...
/-
Evidence/RegionNext6.lean — ROW 326'S REMAINING HYPOTHESES, THIRD PART (§111-§121)

Split out of `RegionNext5` when that file passed 12900 lines, then split again at 12500.
Section numbers are not in file order — sections were appended as their agents finished.
`RegionNext7` carries the part still moving.
-/
