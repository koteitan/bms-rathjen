...
/-
Evidence/RegionNext4.lean — ROW 326'S REMAINING HYPOTHESES, FIRST HALF (§95-§103)

Split out of `RegionNext3` at 17000 lines, then split again at 14000: this half is
settled and caches; `RegionNext5` carries the part still moving.  Section numbers are
not in file order — sections were appended as their agents finished.
-/
