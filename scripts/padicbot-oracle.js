...
//       うち訳が同一 (翻訳の衝突)          1
//       本物の順序不一致                   7
//     CTRL 逆順で壊れる対                  734 / 742
//
// **`TM/Order.lean` の初めての外部検算であり、742 対中 735 で一致する。**
// 残る 7 件はすべて `psi_(Z 0)` か `Z 0` を含む比較で、当方の `lt` の誤り・上の翻訳の
// 誤り・先方の実装の誤りのどれかは未決。**まず翻訳を疑うこと** — 今日その順序を
// 守らずに二度撤回している (`Evidence/SqV.lean` §K3.20 と `plan/chi-2ary.md`)。
