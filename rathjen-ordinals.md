...
| R3 | Stability 系 | $\Pi^1_\nu$-indescribable 基数の階層 | 崩壊関数の階層 | $\mathrm{KPi}+\forall\rho\,\exists\pi{>}\rho\,(\pi \text{ は } \pi^+\text{-stable})$ | 明示名なし(論文 §の上界) | 2005 (An ordinal analysis of stability; 結果自体は 1995 年に得られたもの) |
