...
|---|---|---|---|---|---|---|
| [`(空)`](../lean/Rows/TM.lean#L104) | $`0`$ | $`0`$ | [✅](../lean/Evidence/Cert.lean) | [o](../lean/Trans/TM.lean)+[bisim6](../lean/Evidence/Bisim.lean) | 空行列 |  |
| [`(0)`](../lean/Rows/TM.lean#L106) | $`1`$ | $`1`$ | [✅](../lean/Evidence/Cert.lean) | [o](../lean/Trans/TM.lean)+[bisim6](../lean/Evidence/Bisim.lean) |  |  |
| [`(0)(0)`](../lean/Rows/TM.lean#L107) | $`2`$ | $`2`$ | [✅](../lean/Evidence/Cert.lean) | [o](../lean/Trans/TM.lean)+[bisim6](../lean/Evidence/Bisim.lean) |  |  |
| [`(0)(1)`](../lean/Rows/TM.lean#L108) | $`\omega`$ | $`\omega`$ | [✅](../lean/Evidence/Cert.lean) | [o](../lean/Trans/TM.lean)+[bisim6](../lean/Evidence/Bisim.lean) |  | **M** 1 行行列で成分が増える最初。**T** φ̄ の第 2 引数が 0 でなくなる最初 |
| [`(0)(1)(0)(1)`](../lean/Rows/TM.lean#L111) | $`\omega+\omega`$ | $`\omega\cdot 2`$ | [✅](../lean/Evidence/Cert.lean) | [o](../lean/Trans/TM.lean)+[bisim6](../lean/Evidence/Bisim.lean) |  |  |
| [`(0)(1)(1)`](../lean/Rows/TM.lean#L113) | $`\bar{\varphi}(0,2)`$ | $`\omega^2`$ | [✅](../lean/Evidence/Cert.lean) | [o](../lean/Trans/TM.lean)+[bisim6](../lean/Evidence/Bisim.lean) |  |  |
| [`(0)(1)(2)`](../lean/Rows/TM.lean#L115) | $`\bar{\varphi}(0,\omega)`$ | $`\omega^\omega`$ | [✅](../lean/Evidence/Cert.lean) | [o](../lean/Trans/TM.lean)+[bisim6](../lean/Evidence/Bisim.lean) |  |  |
| [`(0)(1)(2)(3)`](../lean/Rows/TM.lean#L117) | $`\bar{\varphi}(0,\bar{\varphi}(0,\omega))`$ | $`\omega^{\omega^\omega}`$ | [✅](../lean/Evidence/Cert.lean) | [o](../lean/Trans/TM.lean)+[bisim6](../lean/Evidence/Bisim.lean) |  |  |
| **<(0,0)(1,1)** | $`\lt\bar{\varphi}(1,0)`$ | $`\lt\varepsilon_0`$ |  | [checkAll](../lean/Test/TransTest.lean) | 区間の全標準行列 (stdSeq) について、展開の値を一般定理で一括証明 |  |
| [`(0,0)(1,1)`](../lean/Rows/TM.lean#L120) | $`\bar{\varphi}(1,0)`$ | $`\varepsilon_0`$ | [✅](../lean/Evidence/Cert.lean) | [o](../lean/Trans/TM.lean)+[bisim6](../lean/Evidence/Bisim.lean) | 2 行の最初の極限 | **M** 2 行の最初。**T** φ̄ の第 1 引数が 0 でなくなる最初。**B** Ω₁ の最初 |
| [`(0,0)(1,1)(0,0)`](../lean/Rows/TM.lean#L123) | $`\bar{\varphi}(1,0)+1`$ | $`\varepsilon_0+1`$ | [✅](../lean/Evidence/Cert.lean) | [o](../lean/Trans/TM.lean) |  |  |
| [`(0,0)(1,1)(1,0)`](../lean/Rows/TM.lean#L125) | $`\bar{\varphi}(0,\bar{\varphi}(1,0))`$ | $`\omega^{\varepsilon_0+1}`$ | [✅](../lean/Evidence/Cert.lean) | [o](../lean/Trans/TM.lean)+[bisim6](../lean/Evidence/Bisim.lean) |  | **T** φ̄ が不動点を飛ばす最初 (φ̄(0,ε₀) は ε₀ ではない) |
| [`(0,0)(1,1)(1,1)`](../lean/Rows/TM.lean#L128) | $`\bar{\varphi}(1,1)`$ | $`\varepsilon_1`$ | [fₙ](../lean/Rows/Proofs.lean#L345) | [o](../lean/Trans/TM.lean) |  |  |
| [`(0,0)(1,1)(2,0)`](../lean/Rows/TM.lean#L130) | $`\bar{\varphi}(1,\omega)`$ | $`\varepsilon_\omega`$ | [fₙ](../lean/Rows/Proofs.lean#L346) | [o](../lean/Trans/TM.lean) |  | **M** 0 行目が 2 になる最初 |
| [`(0,0)(1,1)(2,0)(0,0)`](../lean/Rows/TM.lean#L133) | $`\bar{\varphi}(1,\omega)+1`$ | $`\varepsilon_\omega+1`$ | [fₙ](../lean/Rows/Proofs.lean#L269) | [o](../lean/Trans/TM.lean) |  |  |
| [`(0,0)(1,1)(2,0)(1,1)(1,0)(2,1)(3,0)(1,0)(2,1)`](../lean/Rows/TM.lean#L136) | $`\bar{\varphi}(0,\bar{\varphi}(1,\omega+1)+\bar{\varphi}(1,\omega)+\bar{\varphi}(1,0))`$ | $`\bar{\varphi}(0,\bar{\varphi}(1,\omega+1)+\bar{\varphi}(1,\omega)+\bar{\varphi}(1,0))`$ | [fₙ](../lean/Rows/Selected.lean#L312) | [oR](../lean/Trans/Recal.lean) | 外部の表と食い違うが決着済み。当方が正しい ([diff.md](diff.md) 族 1) | **D** 外部の表と食い違う 9 行の 1 つ |
| [`(0,0)(1,1)(2,0)(2,0)`](../lean/Rows/TM.lean#L142) | $`\bar{\varphi}(1,\bar{\varphi}(0,2))`$ | $`\varepsilon_{\omega^2}`$ | [fₙ](../lean/Rows/Proofs.lean#L299) | [o](../lean/Trans/TM.lean) |  |  |
| [`(0,0)(1,1)(2,0)(3,0)`](../lean/Rows/TM.lean#L144) | $`\bar{\varphi}(1,\bar{\varphi}(0,\omega))`$ | $`\varepsilon_{\omega^\omega}`$ | [fₙ](../lean/Rows/Proofs.lean#L284) | [o](../lean/Trans/TM.lean) |  |  |
| [`(0,0)(1,1)(2,0)(3,1)`](../lean/Rows/TM.lean#L147) | $`\bar{\varphi}(1,\bar{\varphi}(1,0))`$ | $`\varepsilon_{\varepsilon_0}`$ | [fₙ](../lean/Rows/Proofs.lean#L252) | [o](../lean/Trans/TM.lean) |  |  |
| [`(0,0)(1,1)(2,1)`](../lean/Rows/TM.lean#L149) | $`\bar{\varphi}(2,0)`$ | $`\zeta_0`$ | [fₙ](../lean/Rows/Proofs.lean#L348) | [o](../lean/Trans/TM.lean) |  | **M** (2,1) の最初。**B** ψ₁ が入れ子になる最初 |
| [`(0,0)(1,1)(2,1)(0,0)`](../lean/Rows/TM.lean#L152) | $`\bar{\varphi}(2,0)+1`$ | $`\zeta_0+1`$ | [fₙ](../lean/Rows/Proofs.lean#L164) | [o](../lean/Trans/TM.lean) |  |  |
| [`(0,0)(1,1)(2,1)(1,0)`](../lean/Rows/TM.lean#L154) | $`\bar{\varphi}(0,\bar{\varphi}(2,0))`$ | $`\omega^{\zeta_0+1}`$ | [fₙ](../lean/Rows/Proofs.lean#L191) | [o](../lean/Trans/TM.lean) |  |  |
| [`(0,0)(1,1)(2,1)(1,1)`](../lean/Rows/TM.lean#L156) | $`\bar{\varphi}(1,\bar{\varphi}(2,0))`$ | $`\varepsilon_{\zeta_0+1}`$ | [fₙ](../lean/Rows/Proofs.lean#L234) | [o](../lean/Trans/TM.lean) |  |  |
| [`(0,0)(1,1)(2,1)(1,1)(2,0)(3,1)(4,1)(3,1)(1,1)(2,0)`](../lean/Rows/TM.lean#L160) | $`\bar{\varphi}(1,\bar{\varphi}(1,\bar{\varphi}(2,0))+\omega)`$ | $`\bar{\varphi}(1,\bar{\varphi}(1,\bar{\varphi}(2,0))+\omega)`$ | [fₙ](../lean/Rows/Selected.lean#L573) | [oR](../lean/Trans/Recal.lean) | 外部の表と食い違うが決着済み。当方が正しい ([diff.md](diff.md) 族 2) | **D** 外部の表と食い違う 9 行の 1 つ |
| [`(0,0)(1,1)(2,1)(1,1)(2,0)(3,1)(4,1)(3,1)(1,1)(2,0)(3,1)`](../lean/Rows/TM.lean#L166) | $`\bar{\varphi}(1,\bar{\varphi}(1,\bar{\varphi}(2,0))+\bar{\varphi}(1,0))`$ | $`\bar{\varphi}(1,\bar{\varphi}(1,\bar{\varphi}(2,0))+\bar{\varphi}(1,0))`$ | [fₙ](../lean/Rows/Selected.lean#L843) | [oR](../lean/Trans/Recal.lean) | 外部の表と食い違うが決着済み。当方が正しい ([diff.md](diff.md) 族 2) | **D** 外部の表と食い違う 9 行の 1 つ |
| [`(0,0)(1,1)(2,1)(1,1)(2,0)(3,1)(4,1)(3,1)(4,0)(5,1)(6,1)(5,0)`](../lean/Rows/TM.lean#L173) | $`\bar{\varphi}(1,\bar{\varphi}(1,\bar{\varphi}(0,\bar{\varphi}(0,\bar{\varphi}(2,0)))))`$ | $`\bar{\varphi}(1,\bar{\varphi}(1,\bar{\varphi}(0,\bar{\varphi}(0,\bar{\varphi}(2,0)))))`$ | [fₙ](../lean/Rows/Selected.lean#L1046) | [oR](../lean/Trans/Recal.lean) | 外部の表と食い違うが決着済み。当方が正しい ([diff.md](diff.md) 族 3) | **D** 外部の表と食い違う 9 行の 1 つ。当方が大きい側 |
| [`(0,0)(1,1)(2,1)(1,1)(2,0)(3,1)(4,1)(3,1)(4,0)(5,1)(6,1)(5,0)(6,1)`](../lean/Rows/TM.lean#L179) | $`\bar{\varphi}(1,\bar{\varphi}(1,\bar{\varphi}(0,\bar{\varphi}(0,\bar{\varphi}(2,0)+\bar{\varphi}(1,0)))))`$ | $`\bar{\varphi}(1,\bar{\varphi}(1,\bar{\varphi}(0,\bar{\varphi}(0,\bar{\varphi}(2,0)+\bar{\varphi}(1,0)))))`$ | [fₙ](../lean/Rows/Selected.lean#L1348) | [oR](../lean/Trans/Recal.lean) | 外部の表と食い違うが決着済み。当方が正しい ([diff.md](diff.md) 族 3) | **D** 外部の表と食い違う 9 行の 1 つ。当方が大きい側 |
...
| [`(0,0)(1,1)(2,2)(1,1)`](../lean/Rows/TM.lean#L253) | $`\bar{\varphi}(1,\psi_{\Omega}(Z(1)))`$ | $`\varepsilon_{\psi_0(\Omega_2)+1}`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(1,1)(2,1)`](../lean/Rows/TM.lean#L256) | $`\bar{\varphi}(2,\psi_{\Omega}(Z(1)))`$ | $`\zeta_{\psi_0(\Omega_2)+1}`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(1,1)(2,1)(3,1)`](../lean/Rows/TM.lean#L259) | $`\psi_{\Omega}(Z(1)+1)`$ | $`\Gamma_{\psi_0(\Omega_2)+1}`$ |  | [oR](../lean/Trans/Recal.lean) |  | **T** ψ の引数に Z と和が同居する最初 |
| [`(0,0)(1,1)(2,2)(1,1)(2,2)`](../lean/Rows/TM.lean#L263) | $`\psi_{\Omega}(Z(1)+\bar{\varphi}(1,\Omega))`$ | $`\psi_0(\Omega_2+\psi_1(\Omega_2))`$ | [fₙ](../lean/Rows/G5.lean#L7) | [oR](../lean/Trans/Recal.lean) |  | **T** Ω が φ̄ の引数に現れる最初。**B** ψ₁ の引数に Ω₂ が入る最初 |
| [`(0,0)(1,1)(2,2)(1,1)(2,2)(1,1)(2,2)`](../lean/Rows/TM.lean#L267) | $`\psi_{\Omega}(Z(1)+\bar{\varphi}(1,\Omega)+\bar{\varphi}(1,\Omega))`$ | $`\psi_0(\Omega_2+\psi_1(\Omega_2)\cdot 2)`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(2,0)`](../lean/Rows/TM.lean#L271) | $`\psi_{\Omega}(Z(1)+\bar{\varphi}(0,\bar{\varphi}(1,\Omega)))`$ | $`\psi_0(\Omega_2+\psi_1(\Omega_2+1))`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(2,0)(2,0)`](../lean/Rows/TM.lean#L275) | $`\psi_{\Omega}(Z(1)+\bar{\varphi}(0,\bar{\varphi}(1,\Omega)+1))`$ | $`\psi_0(\Omega_2+\psi_1(\Omega_2+2))`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(2,0)(3,0)`](../lean/Rows/TM.lean#L279) | $`\psi_{\Omega}(Z(1)+\bar{\varphi}(0,\bar{\varphi}(1,\Omega)+\omega))`$ | $`\psi_0(\Omega_2+\psi_1(\Omega_2+\omega))`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(2,0)(3,1)`](../lean/Rows/TM.lean#L283) | $`\psi_{\Omega}(Z(1)+\bar{\varphi}(0,\bar{\varphi}(1,\Omega)+\bar{\varphi}(1,0)))`$ | $`\psi_0(\Omega_2+\psi_1(\Omega_2+\varepsilon_0))`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(2,0)(3,1)(4,2)`](../lean/Rows/TM.lean#L287) | $`\psi_{\Omega}(Z(1)+\bar{\varphi}(0,\bar{\varphi}(1,\Omega)+\psi_{\Omega}(Z(1))))`$ | $`\psi_0(\Omega_2+\psi_1(\Omega_2+\psi_0(\Omega_2)))`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(2,1)`](../lean/Rows/TM.lean#L292) | $`\psi_{\Omega}(Z(1)+\bar{\varphi}(0,\bar{\varphi}(1,\Omega)+\Omega))`$ | $`\psi_0(\Omega_2+\psi_1(\Omega_2+\Omega_1))`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(2,1)(2,1)`](../lean/Rows/TM.lean#L296) | $`\psi_{\Omega}(Z(1)+\bar{\varphi}(0,\bar{\varphi}(1,\Omega)+\Omega+\Omega))`$ | $`\psi_0(\Omega_2+\psi_1(\Omega_2+\Omega_1\cdot 2))`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(2,1)(3,1)`](../lean/Rows/TM.lean#L300) | $`\psi_{\Omega}(Z(1)+\bar{\varphi}(0,\bar{\varphi}(1,\Omega)+\bar{\varphi}(0,\Omega+\Omega)))`$ | $`\psi_0(\Omega_2+\psi_1(\Omega_2+\psi_1(\Omega_1)))`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(2,1)(3,2)`](../lean/Rows/TM.lean#L305) | $`\psi_{\Omega}(Z(1)+\bar{\varphi}(0,\bar{\varphi}(1,\Omega)+\bar{\varphi}(1,\Omega)))`$ | $`\psi_0(\Omega_2+\psi_1(\Omega_2+\psi_1(\Omega_2)))`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(2,2)`](../lean/Rows/TM.lean#L310) | $`\psi_{\Omega}(Z(1)+Z(1))`$ | $`\psi_0(\Omega_2\cdot 2)`$ |  | [oR](../lean/Trans/Recal.lean) | 旧値 φ̄(ω²,0) を訂正 | **B** ψ₀ の引数が和になる最初 |
| [`(0,0)(1,1)(2,2)(2,2)(2,2)`](../lean/Rows/TM.lean#L314) | $`\psi_{\Omega}(Z(1)+Z(1)+Z(1))`$ | $`\psi_0(\Omega_2\cdot 3)`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(3,0)`](../lean/Rows/TM.lean#L318) | $`\psi_{\Omega}(\bar{\varphi}(0,Z(1)))`$ | $`\psi_0(\psi_2(1))`$ | [fₙ](../lean/Rows/Selected.lean#L3557) | [oR](../lean/Trans/Recal.lean) | 旧値 φ̄(ω^ω,0) を訂正 | **M** (2,2) の後に (3,0) が来る最初。**T** Z が ω 冪の中に入る最初 |
| [`(0,0)(1,1)(2,2)(3,0)(3,0)`](../lean/Rows/TM.lean#L323) | $`\psi_{\Omega}(\bar{\varphi}(0,Z(1)+1))`$ | $`\psi_0(\psi_2(2))`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(3,0)(4,0)`](../lean/Rows/TM.lean#L326) | $`\psi_{\Omega}(\bar{\varphi}(0,Z(1)+\omega))`$ | $`\psi_0(\psi_2(\omega))`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(3,0)(4,1)`](../lean/Rows/TM.lean#L329) | $`\psi_{\Omega}(\bar{\varphi}(0,Z(1)+\bar{\varphi}(1,0)))`$ | $`\psi_0(\psi_2(\varepsilon_0))`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(3,0)(4,1)(5,2)`](../lean/Rows/TM.lean#L332) | $`\psi_{\Omega}(\bar{\varphi}(0,Z(1)+\psi_{\Omega}(Z(1))))`$ | $`\psi_0(\psi_2(\psi_0(\Omega_2)))`$ |  | [oR](../lean/Trans/Recal.lean) |  |  |
| [`(0,0)(1,1)(2,2)(3,1)`](../lean/Rows/TM.lean#L336) | $`\psi_{\Omega}(\bar{\varphi}(0,Z(1)+\Omega))`$ | $`\psi_0(\psi_2(\Omega_1))`$ |  | [oR](../lean/Trans/Recal.lean) |  | **B** ψ₂ の引数に Ω₁ が入る最初。表の最上行 |
