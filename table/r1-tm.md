...
| **(0,0)(1,1)…(a,1)(b,0), 2≤b≤a** | $`\bar{\varphi}(b{-}1,\bar{\varphi}(0,\bar{\varphi}(a,0)))`$ | $`\varepsilon_{\zeta_0\cdot\omega},\ldots`$ | [✅](../lean/Evidence/StageB.lean#L3741) |  | 2 パラメータ族の一括証明。これで梯子+1列 (r=0) の全ケースが証明済み |
...
| [`(0,0)(1,1)(2,2)`](../lean/Rows/TM.lean#L141) | $`\bar{\varphi}(\omega,0)`$ | $`\bar{\varphi}(\omega,0)`$ |  | [oStageC](../lean/Trans/StageC.lean) | 行 1 に 2 が現れる最初の行。この行より上の候補行は v0.1.22 の監査で撤回・再導出中 |
